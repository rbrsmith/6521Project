...
public class ReduceSideJoinSecondRound {
	 ...
	 */
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, IntWritable, Tuple> {
		...
		@Override
		public void map(LongWritable key, Text value, OutputCollector<IntWritable, Tuple> output, Reporter reporter)
				throws IOException {
	...
	/**
	 * For key k values are tuples in form (a1,b) or (a2, null) If a1 = a2 we
	 * have a multi-join and emit a,b,k
	 *
	 */
	public static class Reduce extends MapReduceBase implements Reducer<IntWritable, Tuple, Text, NullWritable> {

		@Override
		public void reduce(IntWritable key, Iterator<Tuple> values, OutputCollector<Text, NullWritable> output,
